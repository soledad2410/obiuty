var Layout = function () {
    ...
    var layoutImgPath = '/public/templates/assets/images/';

    var layoutCssPath = '/public/templates/assets/css/';

    var resBreakpointMd = Common.getResponsiveBreakpoint('md');
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var available_height = Common.getViewPort().height - $('.page-footer').outerHeight() - $('.page-header').outerHeight();
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (Common.getViewPort().width >= resBreakpointMd && $(this).parents('.page-sidebar-menu-hover-submenu').size() === 1) { // exit of hover sidebar menu
                return;
            }
        ...
        $('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    Common.initAjax(); // initialize core stuff
                },
    ...
    var handleSidebarToggler = function () {
        var body = $('body');
        if ($.cookie && $.cookie('sidebar_closed') === '1' && Common.getViewPort().width >= resBreakpointMd) {
    ...
    var handle100HeightContent = function () {
        ...
        if (target.hasClass('portlet')) {
            ...
            if (Common.getViewPort().width < resBreakpointMd) {
                Common.destroySlimScroll(portletBody.find('.full-height-content-body')); // destroy slimscroll
                return;
            }
            ...
            if (target.hasClass("full-height-content-scrollable")) {
                ...
                Common.initSlimScroll(portletBody.find('.full-height-content-body'));
            } else {
    ...
    return {
        ...
        getLayoutImgPath: function () {
            return Common.getAssetsPath() + layoutImgPath;
        },

        getLayoutCssPath: function () {
            return Common.getAssetsPath() + layoutCssPath;
        }
    };
